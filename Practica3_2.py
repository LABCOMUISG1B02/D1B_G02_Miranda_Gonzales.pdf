...
from Practica3_1 import Practica3_1  # grc-generated hier_block
...
class Practica3_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.samp_rate = samp_rate = 220.8e6
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 22080000, 10, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 67000, 10, 0, 0)
        self.Practica3_1_0 = Practica3_1(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.Practica3_1_0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.Practica3_1_0, 0))
