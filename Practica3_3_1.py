...
from ModulorAM_D1BG3 import ModulorAM_D1BG3  # grc-generated hier_block
...
class Practica3_3_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica3_3_1")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, 'Ganancia del Tx', "counter", float)
        ...
        self.ModulorAM_D1BG3_0 = ModulorAM_D1BG3(
            Ac=Ac,
            ka=ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.ModulorAM_D1BG3_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ModulorAM_D1BG3_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ModulorAM_D1BG3_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.ModulorAM_D1BG3_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ModulorAM_D1BG3_0.set_Ac(self.Ac)





def main(top_block_cls=Practica3_3_1, options=None):
