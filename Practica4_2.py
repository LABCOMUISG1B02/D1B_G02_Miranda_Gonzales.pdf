...
class Practica4_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica4_2")
        ...
        self._Ac_range = Range(0, 10, 1e-6, 1, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(200000, analog.GR_COS_WAVE, fm, Am, 0, 0)
...
def main(top_block_cls=Practica4_2, options=None):
